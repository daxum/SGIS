...
const char* const BASIC_SHADER = "basicSdr";
const char* const PHONG_SHADER = "phongSdr";
const char* const TEXT_SHADER = "textSdr";
const char* const SKYBOX_SHADER = "skyboxSdr";

//Uniform sets

const char* const PHONG_SET = "phongSet";
const char* const BASIC_SET = "basicSet";
